// Cedarwings SAS — service worker v2.
// Renamed from sw.js to force the browser to install a fresh worker on
// devices whose previous SW got stuck (so stale code can't keep
// serving cached buggy logic). Logic is identical to sw.js v5.
