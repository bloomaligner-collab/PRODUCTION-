  ...
  customer_feedback: {
    fr: {
      ...
      process: [
        ...
        ['4b. Balle dans le camp (⚽ next_action_by)', 'Chaque dossier ouvert affiche un indicateur ⚽ montrant qui doit agir ensuite : rouge « ⚽ vous » = à vous de jouer, vert « ⚽ <nom> » = on attend l\'autre. Quand vous écrivez une réponse dans le chat, la balle bascule automatiquement vers l\'autre personne — assigné qui répond → balle au créateur ; créateur qui répond → balle à l\'assigné. Aucune réaffectation manuelle nécessaire. Utiliser le filtre « ⚽ Ball in my court » pour voir seulement les dossiers où c\'est votre tour. Utiliser « 👀 Mine — waiting on others » pour surveiller ceux dont vous êtes responsable mais où la balle est chez quelqu\'un d\'autre.'],
        ...
        ['8. Clôture du dossier', 'Workflow standard : l\'assigné termine sa partie → clique ✅ Mark Resolved et saisit une note de résolution → la balle bascule vers le créateur. Le créateur (ou un manager) confirme en cliquant 🔒 Close Case. Statut Resolved → Closed avec Resolved Date. Le Tableau de Bord calcule la satisfaction client sur les 30 derniers jours à partir des dossiers clôturés. Pour rouvrir un dossier clos : 🔄 Reopen.'],
      ],
      buttons: [
        ...
        ['✅ Mark Resolved', 'Visible pour l\'assigné. Indique que VOTRE part est terminée. Demande une note de résolution, passe le statut à « resolved » et bascule la balle vers le créateur qui doit confirmer. Le dossier n\'est pas clos tant que le créateur ne confirme pas.'],
        ['🔒 Close Case', 'Visible pour le créateur ou un manager. Confirme la résolution et archive le dossier (statut « closed »). Utiliser après que l\'assigné a cliqué Mark Resolved et que la solution vous satisfait.'],
        ['🔄 Reopen', 'Visible sur les dossiers résolus ou clos. Remet le dossier en file active (statut « open ») avec la balle chez l\'assigné. À utiliser si la solution s\'est avérée insuffisante.'],
        ...
        ['⚽ Pastille rouge sur ligne', 'C\'est à VOUS d\'agir ensuite sur ce dossier. Filtrer « ⚽ Ball in my court » pour ne voir que ceux-là.'],
        ['⚽ Pastille verte sur ligne', 'La balle est chez quelqu\'un d\'autre — pas votre tour. Vous restez propriétaire si « assigned to » indique votre nom.'],
        ['Filtre « ⚽ Ball in my court »', 'Affiche uniquement les dossiers où VOUS devez agir ensuite. Votre liste prioritaire — à vider chaque jour.'],
        ['Filtre « 👀 Mine — waiting on others »', 'Dossiers dont vous êtes l\'assigné mais où la balle est chez le créateur ou un tiers. Liste de surveillance — relancer si ça traîne.'],
        ['Choisir un nom dans le filtre Assignee', 'Sélectionner « 👤 Bastien » (ou un rôle) affiche les dossiers où Bastien doit agir ensuite : balle dans son camp OU rappel de suivi à échéance. Manager peut ainsi voir d\'un coup la to-do de chaque membre de l\'équipe — pas seulement la liste complète de ses affectations.'],
    ...
    en: {
      ...
      process: [
        ...
        ['4b. Ball in court (⚽ next_action_by)', 'Every open record shows a ⚽ chip indicating who must act next: red "⚽ you" = your turn, green "⚽ <name>" = waiting on them. When you send a chat reply, the ball flips automatically to the other party — assignee replies → ball goes to creator; creator replies → ball goes back to assignee. No manual reassignment needed. Use the "⚽ Ball in my court" filter to see only the cases that need YOUR action. Use "👀 Mine — waiting on others" to watch cases you own but where the ball is elsewhere.'],
        ...
        ['8. Close the record', 'Standard workflow: assignee finishes their part → clicks ✅ Mark Resolved and enters a resolution note → ball flips to the creator. The creator (or a manager) confirms by clicking 🔒 Close Case. Status Resolved → Closed with a Resolved Date. The Dashboard computes customer satisfaction (last 30 days) from closed records. To resurrect a closed case: 🔄 Reopen.'],
      ],
      buttons: [
        ...
        ['✅ Mark Resolved', 'Visible to the assignee. Indicates YOUR part is done. Prompts for a resolution note, sets status to "resolved", and flips the ball to the creator to confirm. The case is NOT closed until the creator confirms.'],
        ['🔒 Close Case', 'Visible to the creator or a manager. Confirms the resolution and archives the case (status "closed"). Use after the assignee clicked Mark Resolved and the solution satisfies you.'],
        ['🔄 Reopen', 'Visible on resolved or closed cases. Returns the case to the active queue (status "open") with the ball back with the assignee. Use if the solution turned out to be insufficient.'],
        ...
        ['⚽ Red chip on row', 'YOU must act next on this case. Filter "⚽ Ball in my court" to see only these.'],
        ['⚽ Green chip on row', 'The ball is with someone else — not your turn. You still own it if "assigned to" shows your name.'],
        ['"⚽ Ball in my court" filter', 'Shows only cases where YOU must act next. Your priority list — clear this every day.'],
        ['"👀 Mine — waiting on others" filter', 'Cases you are assigned to but the ball is with the creator or a third party. Watch list — chase if it stalls.'],
        ['Picking a name in the Assignee filter', 'Selecting "👤 Bastien" (or a role) shows the cases where Bastien must act next: ball in his court OR a follow-up reminder due. A manager can pick any name and see exactly that person\'s to-do list — not just the full list of their assignments.'],
